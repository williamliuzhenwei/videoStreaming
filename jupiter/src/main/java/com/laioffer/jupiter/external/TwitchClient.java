...
public class TwitchClient {
    private static final String TOKEN = "Bearer ax0gaznkxuhbi7n9x1d2rjpfymm2as";
    private static final String CLIENT_ID = "68ouvzg0ggg8hi3dgqddfntk8a7pun";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        ResponseHandler<String> responseHandler = response -> {
            ...
            if (responseCode != 200) {
                ...
                throw new TwitchException("Failed to get response from Twitch API");
            }
